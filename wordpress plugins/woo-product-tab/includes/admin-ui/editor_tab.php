        ...
        <div class="wt-admingeneral wt-advanced">
            <div class="wt-faqcnt ">
              ...
              <div class="wt-faqcontent wt-adminadvanced">
       			 <p class="form-field">
           <div class=" custom_tab_options" style="width:100%;margin-right: 5px;float:right">
                <label for="video_products_url" style="margin:0px;"><?php _e('Editor :', EXTRA_WOO_TABS_TEXTDOMAN); ?></label>             								
