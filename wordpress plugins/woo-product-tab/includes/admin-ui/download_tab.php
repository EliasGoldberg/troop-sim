                                        ...
                                        echo '
                                            <div>
												...
												<input name="'.$public_perfix.'tab_posts['.$i.'][file]" id="'.$public_perfix.'tab_posts_file" type="hidden" class="custom_upload_download" value="'.(isset($row['file']) ? $row['file']:'').'"/> 
													...
													<input name="btn_download['.$i.']" class="custom_upload_button_download_new button" type="button" value="'.__('Choose File',EXTRA_WOO_TABS_TEXTDOMAN).'" style="width: auto" /> 
                                    ...
                                    echo '
                                            <div>
                                                ...
                                                <p class="form-field ">
												    ...
												    <input name="'.$public_perfix.'tab_posts['.$i.'][file]" id="'.$public_perfix.'tab_posts_file" type="hidden" class="custom_upload_download" /> 
