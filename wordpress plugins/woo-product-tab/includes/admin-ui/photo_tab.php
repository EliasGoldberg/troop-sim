                                ...
                                echo '
                                    <div>
                                        ...
                                        <p class="form-field ">
											...
											<input name="'.$public_perfix.'tab_posts['.$i.']" id="'.$public_perfix.'tab_posts" type="hidden" class="custom_upload_image_photo" value="'.(isset($row) ? $row:'').'" /> 
						
											<input name="btn_photo['.$i.']" class="custom_upload_image_button_photo_new button" type="button" value="'.__('Choose Image',EXTRA_WOO_TABS_TEXTDOMAN).'" style="width: auto" /> 
                            ...
                            echo '<li>
                                <div>
                                    ...
                                    <p class="form-field ">
										...
										<input name="'.$public_perfix.'tab_posts['.$i.']" id="'.$public_perfix.'tab_posts" type="hidden" class="custom_upload_image_photo"/> 
						
										<input name="btn_photo['.$i.']" class="custom_upload_image_button_photo_new button" type="button" value="'.__('Choose Image',EXTRA_WOO_TABS_TEXTDOMAN).'" style="width: auto" /> 
										<button type="button" class="remove_image_button_photo button">'.__('Remove Image',EXTRA_WOO_TABS_TEXTDOMAN).'</button>
										<img src="" class="custom_preview_image_photo uploader_image_preview" alt="" />
