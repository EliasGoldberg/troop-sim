                            ...
                            echo '			
                                <div>
                                    ...
                                    <p class="form-field ">
										...
										<input name="btn_video['.$i.']" class="custom_upload_video_thumb_button_new button" type="button" value="'.__('Choose Video Thumb',EXTRA_WOO_TABS_TEXTDOMAN).'" /> 
                        ...
                        echo '<li>
                            <div>
                                ...
                                <p class="form-field ">
									...
									<input name="'.$public_perfix.'tab_posts['.$i.'][thumb]" id="video_thumb" type="hidden" class="custom_upload_video_thumb" /> 
