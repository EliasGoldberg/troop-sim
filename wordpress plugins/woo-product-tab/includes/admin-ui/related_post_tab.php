...
<div id="<?php echo $perfix_tab;?>_tab" class="panel woocommerce_options_panel">
    ...
    <div class="wt-admingeneral wt-advanced">
        ...
        <select style="width: 350px;" multiple="" class="related-posts related-posts-<?php echo $rand_id;?>" tabindex="-1" data-placeholder="<?php _e( 'Search for Posts&hellip;', EXTRA_WOO_TABS_TEXTDOMAN ); ?>" name="<?php echo $public_perfix.'tab_posts[]';?>">
            <option value=""></option>
            <?php
        ...
        <script>
        	jQuery(document).ready(function(e) {
				jQuery(".my-tabs").find("a").click(function(){
					if(jQuery(".related-posts-<?php echo $rand_id;?>").is(":visible"))
					{
                		jQuery(".related-posts-<?php echo $rand_id;?>").chosen();
					}
				});
            });
        </script>
