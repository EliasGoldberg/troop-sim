        ...
        <div class="wt-admingeneral wt-advanced">
            <div class="wt-faqcnt ">
              ...
              <div class="wt-faqcontent wt-adminadvanced">
        		<p class="form-field">
                   <div class=" custom_tab_options" style="width:90%;margin-right: 5px;float:right">
                        <p><?php _e('You can put Your shortcode here and Generate form.(Such as Contact form)',EXTRA_WOO_TABS_TEXTDOMAN);?></p>
                        <label for="video_products_url"><?php _e('Contact Form :', EXTRA_WOO_TABS_TEXTDOMAN); ?></label>             								
