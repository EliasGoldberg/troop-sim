<?php
	...
	function show_brands_category_setting_area() {
		...
		if ( in_array( 'woo-brands/main.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) || in_array( 'woo-brand/main.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) 
		{
			$disable=""; 
		}else
		{
										...
										echo '			
											<div>
												...
												<p class="form-field" style="margin-top:10px">
													...
													<input name="btn_'.$field['id'].'['.$i.']" class="custom_upload_video_thumb_button_new button" type="button" value="'.__('Choose Video Thumb',EXTRA_WOO_TABS_TEXTDOMAN).'" style="width: auto" /> 
													<button type="button" class="remove_image_button button">'.__('Remove Image',EXTRA_WOO_TABS_TEXTDOMAN).'</button>
													<img src="'.(isset($image) ? $image:'').'" class="custom_preview_image_video_thumb uploader_image_preview" alt="" />
