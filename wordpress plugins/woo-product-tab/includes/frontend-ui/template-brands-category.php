...
{
	$query=$custom_tab_options['tab_query'];
	$product_id=$custom_tab_options['product_id'];
	$size = 'shop_catalog';
	...
	switch ( $query )
	{
		...
		case "featured_product_category" :
			$query_args = array(
				'posts_per_page' => -1,
				'product_cat' => $product_category,
				'post_type' => 'product',
